...
countdown a = "Ready! " ++ notFakeCountDown a ++ "Liftoff!"
notFakeCountDown :: Integer -> String
notFakeCountDown 0 = ""
notFakeCountDown n = show n ++ "... " ++ notFakeCountDown (n-1)
------------------------------------------------------------------------------
